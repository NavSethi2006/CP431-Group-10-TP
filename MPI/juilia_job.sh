...
echo "  width=$width height=$height chunk_size=$chunk_size"
echo ""
...
do
    ...
    do
        ...
        do
            ...
            outdir="run_np${np}_it${iteration_count}_p${power}_cre${safe_cre}_cim${safe_cim}"

            echo "============================================================"
            echo "Running benchmark: np=$np iterations=$iteration_count power=$power c=($c_re,$c_im)"
